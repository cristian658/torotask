...
<%
	...
	JSONArray comentarios = (JSONArray)request.getAttribute("comentarios");
	JSONArray adjuntos = (JSONArray)request.getAttribute("adjuntos");
	JSONArray integrantes = (JSONArray)request.getAttribute("integrantes");
