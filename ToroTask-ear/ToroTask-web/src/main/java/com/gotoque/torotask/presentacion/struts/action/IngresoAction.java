...
import com.gotoque.torotask.presentacion.struts.form.IngresoForm;
import java.util.Hashtable;
import java.util.Vector;

public class IngresoAction extends DispatchAction {
    ...
    public ActionForward getConsultarTarea(
            ActionMapping mapping,
            ActionForm form,
            HttpServletRequest request,
            HttpServletResponse response) {
    ...
    public ActionForward setActualizaTarea(
            ActionMapping mapping,
            ActionForm form,
            HttpServletRequest request,
            HttpServletResponse response) {
        ...
        try {
            ...
            hParameters.put("proyecto", proyecto);
            ...
            String[] arrayProyecto = proyecto.split(":");
            if (proyecto != "") {
                if (arrayProyecto.length == 1) {
                    hParameters.put("proyecto", proyecto);
                    proyectos = oBDWFMotorConsulta.setInsertaProyecto(hParameters);
                    idproyecto = proyectos.get(0).toString();
                } else {
                    idproyecto = arrayProyecto[0].split("-")[1];
                }
            }
    ...
    public ActionForward getConsultarReporteTarea(
            ActionMapping mapping,
            ActionForm form,
            HttpServletRequest request,
            HttpServletResponse response) {
    ...
    public ActionForward getConsultarGantt(
            ActionMapping mapping,
            ActionForm form,
            HttpServletRequest request,
            HttpServletResponse response) {
    ...
    public ActionForward getConsultarIngenieros(
            ActionMapping mapping,
            ActionForm form,
            HttpServletRequest request,
            HttpServletResponse response) {
    ...
    public ActionForward getConsultaIntegrantes(
            ActionMapping mapping,
            ActionForm form,
            HttpServletRequest request,
            HttpServletResponse response) {
    ...
    public ActionForward getConsultaProyectos(
            ActionMapping mapping,
            ActionForm form,
            HttpServletRequest request,
            HttpServletResponse response) {
    ...
    public ActionForward getConsultaIntegrantesxTarea(
            ActionMapping mapping,
            ActionForm form,
            HttpServletRequest request,
            HttpServletResponse response) {
    ...
    public ActionForward getConsultarAdjuntos(
            ActionMapping mapping,
            ActionForm form,
            HttpServletRequest request,
            HttpServletResponse response) {
    ...
    public ActionForward getConsultarComentarios(
            ActionMapping mapping,
            ActionForm form,
            HttpServletRequest request,
            HttpServletResponse response) {
    ...
    public ActionForward getConsultarEstados(
            ActionMapping mapping,
            ActionForm form,
            HttpServletRequest request,
            HttpServletResponse response) {
    ...
    public ActionForward setEliminaTarea(
            ActionMapping mapping,
            ActionForm form,
            HttpServletRequest request,
            HttpServletResponse response) {
    ...
    public ActionForward setUpLoad(
            ActionMapping mapping,
            ActionForm form,
            HttpServletRequest request,
        ...
        IngresoForm soporteForm = (IngresoForm) form;

        Enumeration e = null;
        FormFile file = null;
        Hashtable h = null;
        Vector vector = new Vector();
        CommonsMultipartRequestHandler cmrh = (CommonsMultipartRequestHandler) soporteForm.getMultipartRequestHandler();
    ...
    public ActionForward descarga(
        ...
        try {
            ...
            for (int i = 0; i < adjuntos.size(); i++) {
                ...
                String[] adjunto = adjuntos.get(i).toString().split("/");

                response.setContentType(adjunto[1]);
                response.setHeader("Content-Disposition", adjunto[0]);
    ...
    public ActionForward setDeleteUpLoad(
            ActionMapping mapping,
            ActionForm form,
            HttpServletRequest request,
            HttpServletResponse response) {
