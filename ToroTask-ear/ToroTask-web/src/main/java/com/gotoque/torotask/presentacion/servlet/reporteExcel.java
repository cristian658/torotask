...
public class reporteExcel extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			headerRow.createCell((short) 8).setCellValue("Horas Cierre Estimado");
			headerRow.createCell((short) 9).setCellValue("Horas Cierre Real");
			...
			for (int i = 0; i < array.length(); i++) {
				...
				headerRow.createCell((short) 6).setCellValue(estado);
				headerRow.createCell((short) 7).setCellValue(descripcion);
				headerRow.createCell((short) 8).setCellValue(totalDiasEstimado);
				headerRow.createCell((short) 9).setCellValue(totalDiasReal);
			}
